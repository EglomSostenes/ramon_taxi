...
class ServicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post servicos_url, params: { servico: { DateTime: @servico.DateTime, email: @servico.email, fone: @servico.fone, nome: @servico.nome } }
    end
  ...
  test "should update servico" do
    patch servico_url(@servico), params: { servico: { DateTime: @servico.DateTime, email: @servico.email, fone: @servico.fone, nome: @servico.nome } }
